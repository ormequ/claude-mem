...
`+JSON.stringify(r,null,2)}catch{u=" "+this.formatData(r)}else u=" "+this.formatData(r);let l="";if(n){let{sessionId:h,memorySessionId:O,correlationId:S,...T}=n;Object.keys(T).length>0&&(l=` {${Object.entries(T).map(([g,C])=>`${g}=${C}`).join(", ")}}`)}let m=`[${o}] [${a}] [${_}] ${c}${t}${l}${u}`;if(this.logFilePath)try{(0,v.appendFileSync)(this.logFilePath,m+`
  ...
  `).get()!=null}function w(i,e,s){try{i.run(e)}catch(t){let n=t instanceof Error?t:new Error(String(t));throw d.warn("DB",`Failed to apply SQLite pragma ${s}`,{sql:e},n),t}}function pe(i,e={}){let{enableWal:s=!0,enableIncrementalAutoVacuum:t=!0}=e;w(i,`PRAGMA busy_timeout = ${Me}`,"busy_timeout"),w(i,"PRAGMA foreign_keys = ON","foreign_keys"),w(i,"PRAGMA synchronous = NORMAL","synchronous"),w(i,`PRAGMA journal_size_limit = ${xe}`,"journal_size_limit"),t&&!Fe(i)&&w(i,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),s&&w(i,"PRAGMA journal_mode = WAL","journal_mode")}var le=4096;var ke=new Set(["set_title","set_prompt_session","remap_project"]),Xe=/^(?:0|[1-9][0-9]*)$/,me=18446744073709551615n;function y(i){throw d.debug("CLOUD_SYNC","Rejected invalid canonical content",{reason:i}),new Error(`canonical content: ${i}`)}function G(i,e={}){return typeof i!="string"||!Xe.test(i)?y("decimal values must be unsigned base-10 strings without leading zeroes"):(BigInt(i)>me&&y("decimal value exceeds uint64"),e.positive&&i==="0"&&y("decimal value must be positive"),i)}function K(i){let e=G(i);return BigInt(e)===me&&y("uint64 sequence overflow"),(BigInt(e)+1n).toString(10)}function Pe(i){(i===null||typeof i!="object"||Array.isArray(i))&&y("mutation must be an object");let e=i;if((typeof e.op!="string"||!ke.has(e.op))&&y("unsupported mutation op"),e.op==="set_title"){let r=x(e,["fields","op","target"],"set_title"),o=B(r.target,["content_session_id","memory_session_id","platform_source"],"set_title.target");o.memory_session_id===void 0&&o.content_session_id===void 0&&y("set_title target requires a session identifier");for(let _ of["memory_session_id","content_session_id","platform_source"])o[_]!==void 0&&D(o[_],_);let a=x(r.fields,["custom_title"],"set_title.fields");D(a.custom_title,"custom_title");return}if(e.op==="set_prompt_session"){let r=x(e,["fields","op","target"],"set_prompt_session"),o=x(r.target,["origin_device_id","origin_local_id"],"set_prompt_session.target");Be(o.origin_device_id),G(o.origin_local_id);let a=B(r.fields,["content_session_id","memory_session_id","platform_source","project"],"set_prompt_session.fields");D(a.memory_session_id,"memory_session_id");for(let _ of["content_session_id","platform_source","project"])a[_]!==void 0&&D(a[_],_);return}let s=x(e,["fields","op","where"],"remap_project"),t=B(s.where,["memory_session_id","merged_into_project_is_null","project"],"remap_project.where");t.project!==void 0&&D(t.project,"project"),t.memory_session_id!==void 0&&D(t.memory_session_id,"memory_session_id"),t.merged_into_project_is_null!==void 0&&t.merged_into_project_is_null!==!0&&y("merged_into_project_is_null may only be true"),Object.keys(t).length===0&&y("remap_project where is empty");let n=B(s.fields,["merged_into_project","project"],"remap_project.fields");n.project!==void 0&&D(n.project,"project"),n.merged_into_project!==void 0&&D(n.merged_into_project,"merged_into_project"),Object.keys(n).length===0&&y("remap_project fields are empty")}function J(i){Pe(i)}function Be(i){return typeof i!="string"||i.length===0||Buffer.byteLength(i,"utf8")>128?y("origin_device_id must be a non-empty string of at most 128 UTF-8 bytes"):i}function D(i,e){return typeof i!="string"||i.length===0||i.trim().length===0||Buffer.byteLength(i,"utf8")>le?y(`${e} must be a non-blank string of at most ${le} UTF-8 bytes`):i}function x(i,e,s){if(i===null||typeof i!="object"||Array.isArray(i))return y(`${s} must be an object`);let t=i,n=Object.keys(t).sort(),r=[...e].sort();return(n.length!==r.length||n.some((o,a)=>o!==r[a]))&&y(`${s} must contain exactly: ${r.join(", ")}`),t}function B(i,e,s){if(i===null||typeof i!="object"||Array.isArray(i))return y(`${s} must be an object`);let t=i,n=new Set(e),r=Object.keys(t).find(o=>!n.has(o));return r&&y(`${s} contains unknown field ${r}`),t}var z=class{db;syncOutboxEnabled;constructor(e=se,s={}){this.syncOutboxEnabled=s.syncOutboxEnabled??!0,e instanceof Q.Database?this.db=e:(e!==":memory:"&&te(I),this.db=new Q.Database(e)),pe(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(),this.ensureSyncOriginColumns(),this.ensureSyncOutbox(),this.ensureSyncEntityLedger(),this.ensureSyncRevisionTextAffinity(),this.initializeSyncHubLaunchBaseline(),this.normalizeConceptTags()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(s=>s.name)}hasUniqueIndexOnColumns(e,s){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let r=this.getIndexColumns(n.name);return r.length===s.length&&r.every((o,a)=>o===s[a])})}resolvePromptSessionDbId(e,s,t){if(s!==void 0)return s;let n=t?L(t):void 0;return n?this.db.prepare(`
    ...
    `),n||this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_platform_source ON sdk_sessions(platform_source)"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(24,new Date().toISOString()))}addObservationModelColumns(){let e=this.db.query("PRAGMA table_info(observations)").all(),s=e.some(n=>n.name==="generated_by_model"),t=e.some(n=>n.name==="relevance_count");s&&t||(s||this.db.run("ALTER TABLE observations ADD COLUMN generated_by_model TEXT"),t||this.db.run("ALTER TABLE observations ADD COLUMN relevance_count INTEGER DEFAULT 0"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(26,new Date().toISOString()))}ensureMergedIntoProjectColumns(){let e=this.db.query("PRAGMA table_info(observations)").all();e.some(n=>n.name==="merged_into_project")||this.db.run("ALTER TABLE observations ADD COLUMN merged_into_project TEXT"),this.db.run("CREATE INDEX IF NOT EXISTS idx_observations_merged_into ON observations(merged_into_project)"),e.some(n=>n.name==="chroma_merge_synced_at")||this.db.run("ALTER TABLE observations ADD COLUMN chroma_merge_synced_at INTEGER");let s=this.db.query("PRAGMA table_info(session_summaries)").all();s.some(n=>n.name==="merged_into_project")||this.db.run("ALTER TABLE session_summaries ADD COLUMN merged_into_project TEXT"),this.db.run("CREATE INDEX IF NOT EXISTS idx_summaries_merged_into ON session_summaries(merged_into_project)"),s.some(n=>n.name==="chroma_merge_synced_at")||this.db.run("ALTER TABLE session_summaries ADD COLUMN chroma_merge_synced_at INTEGER"),this.db.query("PRAGMA table_info(sdk_sessions)").all().some(n=>n.name==="merged_into_project")||(this.db.run("ALTER TABLE sdk_sessions ADD COLUMN merged_into_project TEXT"),this.db.run(`UPDATE sdk_sessions SET merged_into_project = (
         ...
         WHERE merged_into_project IS NULL
           AND project IN (SELECT project FROM observations WHERE merged_into_project IS NOT NULL)`)),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_merged_into ON sdk_sessions(merged_into_project)"),this.db.run(`CREATE INDEX IF NOT EXISTS idx_observations_merge_unsynced ON observations(id)
    ...
    `),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(29,new Date().toISOString())}addObservationsMetadataColumn(){this.db.query("PRAGMA table_info(observations)").all().some(t=>t.name==="metadata")||(this.db.run("ALTER TABLE observations ADD COLUMN metadata TEXT"),d.debug("DB","Added metadata column to observations table (#2116)")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(30,new Date().toISOString())}updateMemorySessionId(e,s){this.db.prepare(`
      ...
      WHERE id = ?
    `).run(s,e),s&&this.requeuePromptSync(e)}enqueueMutationOp(e,s){let t=JSON.parse(JSON.stringify(s));if(t.op==="set_prompt_session"){let n=t.target;n?.origin_device_id===null&&(n.origin_device_id="self")}J(t),this.syncOutboxEnabled&&this.db.prepare(`
    ...
    `).all(j),s=[],t=new Set,n={};for(let o of e){let a=L(o.platform_source);n[a]||(n[a]=[]),n[a].includes(o.project)||n[a].push(o.project),t.has(o.project)||(t.add(o.project),s.push(o.project))}let r=ie(Object.keys(n));return{projects:s,sources:r,projectsBySource:Object.fromEntries(r.map(o=>[o,n[o]||[]]))}}getLatestUserPrompt(e,s){let t=this.resolvePromptSessionDbId(e,s),n=t!==null?"up.session_db_id = ?":"up.content_session_id = ?",r=t!==null?t:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(r)}findRecentDuplicateUserPrompt(e,s,t,n){return ae(this.db,e,P(s),t,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,s=3,t){let n=[e,e],r="";return t&&(r=`AND COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`,n.push(L(t))),n.push(s),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,L(s))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:r,platformSource:o,type:a,concepts:_,files:c}=s,u=t==="relevance",l=u?"":`ORDER BY o.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,m=n&&!u?`LIMIT ${n}`:"",h=e.map(()=>"?").join(","),O=[...e],S=[];if(r&&(S.push("(o.project = ? OR o.merged_into_project = ?)"),O.push(r,r)),o&&(S.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),O.push(L(o))),a)if(Array.isArray(a)){let R=a.map(()=>"?").join(",");S.push(`o.type IN (${R})`),O.push(...a)}else S.push("o.type = ?"),O.push(a);if(_){let R=Array.isArray(_)?_:[_],f=R.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");O.push(...R),S.push(`(${f.join(" OR ")})`)}if(c){let R=Array.isArray(c)?c:[c],f=R.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");R.forEach(A=>{O.push(`%${A}%`,`%${A}%`)}),S.push(`(${f.join(" OR ")})`)}let T=S.length>0?`WHERE o.id IN (${h}) AND ${S.join(" AND ")}`:`WHERE o.id IN (${h})`,g=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${T}
    ...
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,n||null,r,_,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,s,t,n,r,o=0,a,_){let c=a??Date.now(),u=new Date(c).toISOString();return this.db.transaction(()=>{let m=[],h=this.db.prepare(`
        ...
        RETURNING id
      `),O=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let T of t){let N=oe(e,T.title,T.narrative),g=h.get(e,s,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),r||null,o,T.agent_type??null,T.agent_id??null,N,u,c,_||null,T.metadata??null);if(g){m.push(g.id);continue}let C=O.get(e,N);if(!C)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${N}`);m.push(C.id)}let S=null;if(n){let N=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,s,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,r||null,o,u,c);S=Number(N.lastInsertRowid)}return{observationIds:m,summaryId:S,createdAtEpoch:c}})()}getSessionSummariesByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:r,platformSource:o}=s,a=t==="relevance",_=a?"":`ORDER BY ss.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),l=[...e],m=[];r&&(m.push("(ss.project = ? OR ss.merged_into_project = ?)"),l.push(r,r)),o&&(m.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),l.push(L(o)));let h=m.length>0?`AND ${m.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT ss.*
      ...
      ${_}
      ${c}
    `).all(...l);if(!a)return S;let T=new Map(S.map(g=>[g.id,g])),N=e.map(g=>T.get(g)).filter(g=>!!g);return n?N.slice(0,n):N}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:r,platformSource:o}=s,a=t==="relevance",_=a?"":`ORDER BY up.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),l=[...e],m=[];r&&(m.push("(s.project = ? OR s.merged_into_project = ?)"),l.push(r,r)),o&&(m.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),l.push(L(o)));let h=m.length>0?`AND ${m.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      FROM user_prompts up
      -- fork: LEFT, not INNER. 65 of 3051 prompts carry session_db_id IS NULL, and an inner
      -- join made them unfetchable by id \u2014 /api/prompt/:id 404s them and the batch route
      -- returns short without saying so. getObservationsByIds already LEFT JOINs. A project
      -- filter still excludes them, correctly: an unattributed prompt belongs to no project.
      LEFT JOIN sdk_sessions s ON up.session_db_id = s.id
      WHERE up.id IN (${u}) ${h}
      ${_}
      ${c}
    `).all(...l);if(!a)return S;let T=new Map(S.map(g=>[g.id,g])),N=e.map(g=>T.get(g)).filter(g=>!!g);return n?N.slice(0,n):N}getTimelineAroundTimestamp(e,s=10,t=10,n,r){return this.getTimelineAroundObservation(null,e,s,t,n,r)}getTimelineAroundObservation(e,s,t=10,n=10,r,o){let a=o?L(o):void 0,_=(E,R,f=!1)=>{let A=[],F=[];return r&&(f?(A.push(`(${E}.project = ? OR ${E}.merged_into_project = ?)`),F.push(r,r)):(A.push(`${E}.project = ?`),F.push(r))),a&&(A.push(`COALESCE(NULLIF(${R}.platform_source, ''), '${p}') = ?`),F.push(a)),{clause:A.length>0?`AND ${A.join(" AND ")}`:"",params:F}},c=_("o","src",!0),u=_("ss","src",!0),l=_("s","s",!0),m,h;if(e!==null){let E=`
      ...
      `,R=`
        ...
        ORDER BY o.id ASC
        LIMIT ?
      `;try{let f=this.db.prepare(E).all(e,...c.params,t+1),A=this.db.prepare(R).all(e,...c.params,n+1);if(f.length===0&&A.length===0)return{observations:[],sessions:[],prompts:[]};m=f.length>0?f[f.length-1].created_at_epoch:s,h=A.length>0?A[A.length-1].created_at_epoch:s}catch(f){return f instanceof Error?d.error("DB","Error getting boundary observations",{project:r},f):d.error("DB","Error getting boundary observations with non-Error",{},new Error(String(f))),{observations:[],sessions:[],prompts:[]}}}else{let E=`
      ...
      `,R=`
        ...
        LIMIT ?
      `;try{let f=this.db.prepare(E).all(s,...c.params,t),A=this.db.prepare(R).all(s,...c.params,n+1);if(f.length===0&&A.length===0)return{observations:[],sessions:[],prompts:[]};m=f.length>0?f[f.length-1].created_at_epoch:s,h=A.length>0?A[A.length-1].created_at_epoch:s}catch(f){return f instanceof Error?d.error("DB","Error getting boundary timestamps",{project:r},f):d.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(f))),{observations:[],sessions:[],prompts:[]}}}let O=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id

"use strict";var Ws=Object.create;var q=Object.defineProperty;var Vs=Object.getOwnPropertyDescriptor;var qs=Object.getOwnPropertyNames;var Ys=Object.getPrototypeOf,Ks=Object.prototype.hasOwnProperty;var Js=(r,e)=>{for(var s in e)q(r,s,{get:e[s],enumerable:!0})},be=(r,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of qs(e))!Ks.call(r,n)&&n!==s&&q(r,n,{get:()=>e[n],enumerable:!(t=Vs(e,n))||t.enumerable});return r};var H=(r,e,s)=>(s=r!=null?Ws(Ys(r)):{},be(e||!r||!r.__esModule?q(s,"default",{value:r,enumerable:!0}):s,r)),Qs=r=>be(q({},"__esModule",{value:!0}),r);var Ut={};Js(Ut,{generateContext:()=>js,generateContextWithStats:()=>Oe});module.exports=Qs(Ut);var Gs=H(require("path"),1),Xs=require("os"),Bs=require("fs");var pe=require("bun:sqlite"),J=require("fs");var S=require("path"),ae=require("os"),P=require("fs"),Ne=require("url");var T=require("fs"),he=require("crypto"),y=require("path");var zs=null;function Zs(r){return(zs??process.stderr.write.bind(process.stderr))(r)}function w(r){Zs(r)}var et=process.platform==="win32";function st(r){return r.replace(/^\uFEFF/,"")}function k(r){return JSON.parse(st(r))}function tt(r){(0,T.existsSync)(r)||(0,T.mkdirSync)(r,{recursive:!0})}function ie(r,e){let s=r;try{if((0,T.lstatSync)(r).isSymbolicLink())try{s=(0,T.realpathSync)(r)}catch(_){let u=_ instanceof Error?_:new Error(String(_));w(`claude-mem: realpathSync failed for ${r}, resolving symlink manually: ${u.message}
`);let c=(0,T.readlinkSync)(r);s=(0,y.resolve)((0,y.dirname)(r),c)}}catch(_){let u=_.code;if(u!=="ENOENT"&&u!=="ENOTDIR")throw _}tt((0,y.dirname)(s));let t=(0,y.dirname)(s),n=(0,y.basename)(s),o=(0,y.join)(t,`.${n}.${process.pid}.${(0,he.randomBytes)(6).toString("hex")}.tmp`),i=Buffer.from(JSON.stringify(e,null,2)+`
`,"utf-8"),a;try{a=(0,T.statSync)(s).mode&511}catch{}let d;try{d=a!==void 0?(0,T.openSync)(o,"w",a):(0,T.openSync)(o,"w");let _=0;for(;_<i.length;){let u=(0,T.writeSync)(d,i,_,i.length-_);if(u===0)throw new Error(`writeSync stalled at ${_}/${i.length} bytes`);_+=u}if((0,T.fsyncSync)(d),(0,T.closeSync)(d),d=void 0,(0,T.renameSync)(o,s),!et){let u;try{u=(0,T.openSync)(t,"r"),(0,T.fsyncSync)(u)}catch(c){let p=c instanceof Error?c:new Error(String(c));w(`claude-mem: directory fsync failed for ${t}: ${p.message}
`)}finally{if(u!==void 0)try{(0,T.closeSync)(u)}catch{}}}}catch(_){if(d!==void 0)try{(0,T.closeSync)(d)}catch{}try{(0,T.unlinkSync)(o)}catch{}throw _}}var dt={};function rt(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,Ne.fileURLToPath)(dt.url))}var nt=rt();function ot(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,S.join)((0,ae.homedir)(),".claude-mem"),e=(0,S.join)(r,"settings.json");try{if((0,P.existsSync)(e)){let s=k((0,P.readFileSync)(e,"utf-8")),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return t.CLAUDE_MEM_DATA_DIR}}catch{}return r}var I=ot(),de=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,ae.homedir)(),".claude"),Ht=(0,S.join)(de,"plugins","marketplaces","ormequ"),it=(0,S.join)(I,"logs"),Gt=(0,S.join)(I,"settings.json"),Ie=(0,S.join)(I,"claude-mem.db"),at=(0,S.join)(I,"observer-sessions"),_e=(0,S.basename)(at);function Ae(r){(0,P.mkdirSync)(r,{recursive:!0})}function Le(){return(0,S.join)(nt,"..")}var x={dataDir:()=>I,workerPid:()=>(0,S.join)(I,"worker.pid"),serverPid:()=>(0,S.join)(I,".server-beta.pid"),serverPort:()=>(0,S.join)(I,".server-beta.port"),serverRuntime:()=>(0,S.join)(I,".server-beta.runtime.json"),settings:()=>(0,S.join)(I,"settings.json"),database:()=>(0,S.join)(I,"claude-mem.db"),chroma:()=>(0,S.join)(I,"chroma"),combinedCerts:()=>(0,S.join)(I,"combined_certs.pem"),transcriptsConfig:()=>(0,S.join)(I,"transcript-watch.json"),transcriptsState:()=>(0,S.join)(I,"transcript-watch-state.json"),cloudSyncState:()=>(0,S.join)(I,"cloud-sync-state.json"),corpora:()=>(0,S.join)(I,"corpora"),supervisorRegistry:()=>(0,S.join)(I,"supervisor.json"),envFile:()=>(0,S.join)(I,".env"),logsDir:()=>it};var v=require("fs"),Ce=require("path");var ue=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(ue||{}),Ee=null,me=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ce.join)(e,`claude-mem-${s}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,v.existsSync)(e)){let s=(0,v.readFileSync)(e,"utf-8"),n=(k(s).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=ue[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let s=Object.keys(e);return s.length===0?"{}":s.length<=3?JSON.stringify(e):`{${s.length} keys: ${s.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,s){if(!s)return e;let t=s;if(typeof s=="string")try{t=JSON.parse(s)}catch{t=s}if(e==="Bash"&&t.command)return`${e}(${t.command})`;if(t.file_path)return`${e}(${t.file_path})`;if(t.notebook_path)return`${e}(${t.notebook_path})`;if(e==="Glob"&&t.pattern)return`${e}(${t.pattern})`;if(e==="Grep"&&t.pattern)return`${e}(${t.pattern})`;if(t.url)return`${e}(${t.url})`;if(t.query)return`${e}(${t.query})`;if(e==="Task"){if(t.subagent_type)return`${e}(${t.subagent_type})`;if(t.description)return`${e}(${t.description})`}return e==="Skill"&&t.skill?`${e}(${t.skill})`:e==="LSP"&&t.operation?`${e}(${t.operation})`:e}formatTimestamp(e){let s=e.getFullYear(),t=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${s}-${t}-${n} ${o}:${i}:${a}.${d}`}log(e,s,t,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=ue[e].padEnd(5),d=s.padEnd(6),_="";n?.correlationId?_=`[${n.correlationId}] `:n?.sessionId&&(_=`[session-${n.sessionId}] `);let u="";if(o!=null)if(o instanceof Error)u=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{u=`
`+JSON.stringify(o,null,2)}catch{u=" "+this.formatData(o)}else u=" "+this.formatData(o);let c="";if(n){let{sessionId:g,memorySessionId:N,correlationId:h,...f}=n;Object.keys(f).length>0&&(c=` {${Object.entries(f).map(([C,U])=>`${C}=${U}`).join(", ")}}`)}let p=`[${i}] [${a}] [${d}] ${_}${t}${c}${u}`;if(this.logFilePath)try{(0,v.appendFileSync)(this.logFilePath,p+`
`,"utf8")}catch(g){let N=g instanceof Error?g:new Error(String(g));w(`[LOGGER] Failed to write to log file: ${N.message}
${N.stack??""}
`)}else w(p+`
`)}debug(e,s,t,n){this.log(0,e,s,t,n)}info(e,s,t,n){this.log(1,e,s,t,n)}warn(e,s,t,n){this.log(2,e,s,t,n)}setErrorSink(e){Ee=e}error(e,s,t,n){this.log(3,e,s,t,n),this.routeErrorToSink(s,t,n)}routeErrorToSink(e,s,t){try{if(!Ee||!(t instanceof Error))return;Ee(t)}catch{}}dataIn(e,s,t,n){this.info(e,`\u2192 ${s}`,t,n)}dataOut(e,s,t,n){this.info(e,`\u2190 ${s}`,t,n)}success(e,s,t,n){this.info(e,`\u2713 ${s}`,t,n)}failure(e,s,t,n){this.error(e,`\u2717 ${s}`,t,n)}},E=new me;var De=require("crypto");function Me(r,e,s){return(0,De.createHash)("sha256").update([r||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}var l="claude";function _t(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function L(r){if(!r)return l;let e=_t(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:l}function ye(r){let e=["claude","codex","cursor"];return[...r].sort((s,t)=>{let n=e.indexOf(s),o=e.indexOf(t);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:s.localeCompare(t)})}function ve(r,e,s,t,n){let o=Date.now()-t,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(a,s,o)??void 0}var we=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],Ue=new RegExp(`<(${we.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),ke=/<system-reminder>[\s\S]*?<\/system-reminder>/g,xe=100;function Et(r){let e=Object.fromEntries(we.map(n=>[n,0]));Ue.lastIndex=0;let s=0,t=r.replace(Ue,(n,o)=>(e[o]=(e[o]??0)+1,s+=1,""));return s>xe&&E.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:s,maxAllowed:xe,contentLength:r.length}),{stripped:t.trim(),counts:e}}function Pe(r){return Et(r).stripped}var ut=["task-notification"],zt=new RegExp(`^\\s*<(${ut.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),Zt=256*1024;var ce=4e3;function Y(r){let e=r.trim(),t=Pe(r).trim()||e;return t.length<=ce?t:(E.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:t.length,storedLength:ce}),`${t.slice(0,ce-1)}\u2026`)}var mt=require("bun:sqlite");var ct=5e3,pt=4194304;function lt(r){return r.prepare(`
    SELECT name
    FROM sqlite_master
    WHERE type = 'table'
      AND name NOT LIKE 'sqlite_%'
    LIMIT 1
  `).get()!=null}function F(r,e,s){try{r.run(e)}catch(t){let n=t instanceof Error?t:new Error(String(t));throw E.warn("DB",`Failed to apply SQLite pragma ${s}`,{sql:e},n),t}}function Fe(r,e={}){let{enableWal:s=!0,enableIncrementalAutoVacuum:t=!0}=e;F(r,`PRAGMA busy_timeout = ${ct}`,"busy_timeout"),F(r,"PRAGMA foreign_keys = ON","foreign_keys"),F(r,"PRAGMA synchronous = NORMAL","synchronous"),F(r,`PRAGMA journal_size_limit = ${pt}`,"journal_size_limit"),t&&!lt(r)&&F(r,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),s&&F(r,"PRAGMA journal_mode = WAL","journal_mode")}var K=class{db;constructor(e=Ie,s={}){e instanceof pe.Database?this.db=e:(e!==":memory:"&&Ae(I),this.db=new pe.Database(e)),Fe(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(s.cloudSyncStatePath??x.cloudSyncState()),this.requeuePromptCloudSyncAfterMapperFix()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(s=>s.name)}hasUniqueIndexOnColumns(e,s){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let o=this.getIndexColumns(n.name);return o.length===s.length&&o.every((i,a)=>i===s[a])})}resolvePromptSessionDbId(e,s,t){if(s!==void 0)return s;let n=t?L(t):void 0;return n?this.db.prepare(`
        SELECT id
        FROM sdk_sessions
    ...
    `).get(e);if(!n)throw new Error(`Session ${e} not found in sdk_sessions`);n.memory_session_id!==s&&(this.db.prepare(`
      ...
      `).run(s,e),this.requeuePromptSync(e),E.info("DB","Registered memory_session_id before storage (FK fix)",{sessionDbId:e,oldId:n.memory_session_id,newId:s})),typeof t=="number"&&n.worker_port!==t&&this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[_e];return s&&(t+=" AND COALESCE(platform_source, ?) = ?",n.push(l,s)),t+=" ORDER BY project ASC",this.db.prepare(t).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(_e),s=[],t=new Set,n={};for(let i of e){let a=L(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),t.has(i.project)||(t.add(i.project),s.push(i.project))}let o=ye(Object.keys(n));return{projects:s,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e,s){let t=this.resolvePromptSessionDbId(e,s),n=t!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=t!==null?t:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,s,t,n){return ve(this.db,e,Y(s),t,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,s=3,t){let n=[e],o="";return t&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`,n.push(L(t))),n.push(s),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,L(s))||null:this.db.prepare(`
      ...
      ${c}
      ${p}
    `).all(...N);if(!u)return C;let U=new Map(C.map(A=>[A.id,A])),O=e.map(A=>U.get(A)).filter(A=>!!A);return n?O.slice(0,n):O}getSummaryForSession(e,s){let t=[e],n="";return s&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,s,t,n,o){let i=new Date,a=i.getTime(),d=o?L(o):l,_=Y(t),u=this.db.prepare(`
    ...
    `).get(l,d,e);if(u)return s&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,s,d,_,n||null,i.toISOString(),a);return Number(c.lastInsertRowid)}saveUserPrompt(e,s,t,n){let o=new Date,i=o.getTime(),a=Y(t),d=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,s,t,n,o,i=0,a,d){let _=a??Date.now(),u=new Date(_).toISOString();return this.db.transaction(()=>{let p=[],g=this.db.prepare(`
        ...
        RETURNING id
      `),N=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let f of t){let R=Me(e,f.title,f.narrative),C=g.get(e,s,f.type,f.title,f.subtitle,JSON.stringify(f.facts),f.narrative,JSON.stringify(f.concepts),JSON.stringify(f.files_read),JSON.stringify(f.files_modified),o||null,i,f.agent_type??null,f.agent_id??null,R,u,_,d||null,f.metadata??null);if(C){p.push(C.id);continue}let U=N.get(e,R);if(!U)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${R}`);p.push(U.id)}let h=null;if(n){let R=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,s,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,u,_);h=Number(R.lastInsertRowid)}return{observationIds:p,summaryId:h,createdAtEpoch:_}})()}getSessionSummariesByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:o,platformSource:i}=s,a=t==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,_=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),c=[...e],p=[];o&&(p.push("(ss.project = ? OR ss.merged_into_project = ?)"),c.push(o,o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),c.push(L(i)));let g=p.length>0?`AND ${p.join(" AND ")}`:"",h=this.db.prepare(`
      SELECT ss.*
      ...
      ${d}
      ${_}
    `).all(...c);if(!a)return h;let f=new Map(h.map(C=>[C.id,C])),R=e.map(C=>f.get(C)).filter(C=>!!C);return n?R.slice(0,n):R}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:o,platformSource:i}=s,a=t==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,_=n?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),c=[...e],p=[];o&&(p.push("s.project = ?"),c.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),c.push(L(i)));let g=p.length>0?`AND ${p.join(" AND ")}`:"",h=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${_}
    `).all(...c);if(!a)return h;let f=new Map(h.map(R=>[R.id,R]));return e.map(R=>f.get(R)).filter(R=>!!R)}getTimelineAroundTimestamp(e,s=10,t=10,n,o){return this.getTimelineAroundObservation(null,e,s,t,n,o)}getTimelineAroundObservation(e,s,t=10,n=10,o,i){let a=i?L(i):void 0,d=(O,A)=>{let b=[],D=[];return o&&(b.push(`${O}.project = ?`),D.push(o)),a&&(b.push(`COALESCE(NULLIF(${A}.platform_source, ''), '${l}') = ?`),D.push(a)),{clause:b.length>0?`AND ${b.join(" AND ")}`:"",params:D}},_=d("o","src"),u=d("ss","src"),c=d("s","s"),p,g;if(e!==null){let O=`
      ...
      `,A=`
        ...
        LIMIT ?
      `;try{let b=this.db.prepare(O).all(s,..._.params,t),D=this.db.prepare(A).all(s,..._.params,n+1);if(b.length===0&&D.length===0)return{observations:[],sessions:[],prompts:[]};p=b.length>0?b[b.length-1].created_at_epoch:s,g=D.length>0?D[D.length-1].created_at_epoch:s}catch(b){return b instanceof Error?E.error("DB","Error getting boundary timestamps",{project:o},b):E.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(b))),{observations:[],sessions:[],prompts:[]}}}let N=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
  ...
  `).all(...e,...e,t??null,t??null,...n,...i,s.totalObservationCount)}function es(r,e,s,t){let n=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    LIMIT ?
  `).all(...e,...e,t??null,t??null,s.sessionCount+Ke)}function St(r){return r.replace(/[/.]/g,"-")}function ft(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let s="";for(let t of e.message.content)t.type==="text"&&(s+=t.text);if(s=s.replace(ke,"").trim(),s)return s}return null}function Rt(r){for(let e=r.length-1;e>=0;e--)try{let s=ft(r[e]);if(s)return s}catch(s){s instanceof Error?E.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},s):E.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(s)});continue}return""}function Ot(r){try{if(!(0,te.existsSync)(r))return{assistantMessage:""};let e=(0,te.readFileSync)(r,"utf-8").trim();if(!e)return{assistantMessage:""};let s=e.split(`
`).filter(n=>n.trim());return{assistantMessage:Rt(s)}}catch(e){return e instanceof Error?E.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):E.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{assistantMessage:""}}}function ss(r,e,s,t){if(!e.showLastMessage||r.length===0)return{assistantMessage:""};let n=r.find(d=>d.memory_session_id!==s);if(!n)return{assistantMessage:""};let o=n.memory_session_id,i=St(t),a=ze.default.join(de,"projects",i,`${o}.jsonl`);return Ot(a)}function ts(r,e){let s=Qe(e),t=new Set(Qe(r).map(o=>o.id)),n=s[0]?.id;return s.filter(o=>t.has(o.id)).map((o,i)=>{let a=i===0?null:s[i+1];return{...o,displayEpoch:a?a.created_at_epoch:o.created_at_epoch,displayTime:a?a.created_at:o.created_at,shouldShowLink:o.id!==n}})}function bt(r){return!!(r.investigated?.trim()||r.learned?.trim()||r.completed?.trim()||r.next_steps?.trim())}function Qe(r){let e=new Set,s=[];for(let t of r)bt(t)&&(e.has(t.memory_session_id)||(e.add(t.memory_session_id),s.push(t)));return s}function rs(r,e){let s=[...r.map(t=>({type:"observation",data:t})),...e.map(t=>({type:"summary",data:t}))];return s.sort((t,n)=>{let o=t.type==="observation"?t.data.created_at_epoch:t.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),s}function ns(r,e){return new Set(r.slice(0,e).map(s=>s.id))}function os(){let r=new Date,e=r.toLocaleDateString("en-CA"),s=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),t=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${s} ${t}`}function is(r){return[`# [${r}] recent context, ${os()}`,""]}function as(){return[`Legend: \u{1F3AF}session ${M.getInstance().getActiveMode().observation_types.map(s=>`${s.emoji}${s.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function ds(r,e){let s=[],t=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?t.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&t.push(`${r.savings.toLocaleString()}t saved`)),s.push(`Stats: ${t.join(" | ")}`),s.push(""),s}function _s(r){return[`### ${r}`]}function Es(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function us(r,e,s){let t=r.title||"Untitled",n=M.getInstance().getTypeIcon(r.type),o=e?Es(e):'"';return`${r.id} ${o} ${n} ${t}`}function ms(r,e,s,t){let n=[],o=r.title||"Untitled",i=M.getInstance().getTypeIcon(r.type),a=e?Es(e):'"',{readTokens:d,discoveryDisplay:_}=j(r,t);n.push(`**${r.id}** ${a} ${i} **${o}**`),s&&n.push(s);let u=[];return t.showReadTokens&&u.push(`~${d}t`),t.showWorkTokens&&u.push(_),u.length>0&&n.push(u.join(" ")),n.push(""),n}function cs(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function W(r,e){return e?[`**${r}**: ${e}`,""]:[]}function ps(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function ls(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function Ts(r){return`# [${r}] recent context, ${os()}

No previous sessions found.`}function gs(){let r=new Date,e=r.toLocaleDateString("en-CA"),s=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),t=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${s} ${t}`}function Ss(r){return["",`${m.bright}${m.cyan}[${r}] recent context, ${gs()}${m.reset}`,`${m.gray}${"\u2500".repeat(60)}${m.reset}`,""]}function fs(){let e=M.getInstance().getActiveMode().observation_types.map(s=>`${s.emoji} ${s.id}`).join(" | ");return[`${m.dim}Legend: session-request | ${e}${m.reset}`,""]}function Rs(){return[`${m.bright}Column Key${m.reset}`,`${m.dim}  Read: Tokens to read this observation (cost to learn it now)${m.reset}`,`${m.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${m.reset}`,""]}function Os(){return[`${m.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${m.reset}`,"",`${m.dim}When you need implementation details, rationale, or debugging context:${m.reset}`,`${m.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${m.reset}`,`${m.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${m.reset}`,`${m.dim}  - Trust this index over re-reading code for past decisions and learnings${m.reset}`,""]}function bs(r,e){let s=[];if(s.push(`${m.bright}${m.cyan}Context Economics${m.reset}`),s.push(`${m.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${m.reset}`),s.push(`${m.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${m.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let t="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?t+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?t+=`${r.savings.toLocaleString()} tokens`:t+=`${r.savingsPercent}% reduction from reuse`,s.push(`${m.green}${t}${m.reset}`)}return s.push(""),s}function hs(r){return[`${m.bright}${m.cyan}${r}${m.reset}`,""]}function Ns(r){return[`${m.dim}${r}${m.reset}`]}function Is(r,e,s,t){let n=r.title||"Untitled",o=M.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=j(r,t),_=s?`${m.dim}${e}${m.reset}`:" ".repeat(e.length),u=t.showReadTokens&&i>0?`${m.dim}(~${i}t)${m.reset}`:"",c=t.showWorkTokens&&a>0?`${m.dim}(${d} ${a.toLocaleString()}t)${m.reset}`:"";return`  ${m.dim}#${r.id}${m.reset}  ${_}  ${o}  ${n} ${u} ${c}`}function As(r,e,s,t,n){let o=[],i=r.title||"Untitled",a=M.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:_,workEmoji:u}=j(r,n),c=s?`${m.dim}${e}${m.reset}`:" ".repeat(e.length),p=n.showReadTokens&&d>0?`${m.dim}(~${d}t)${m.reset}`:"",g=n.showWorkTokens&&_>0?`${m.dim}(${u} ${_.toLocaleString()}t)${m.reset}`:"";return o.push(`  ${m.dim}#${r.id}${m.reset}  ${c}  ${a}  ${m.bright}${i}${m.reset}`),t&&o.push(`    ${m.dim}${t}${m.reset}`),(p||g)&&o.push(`    ${p} ${g}`),o.push(""),o}function Ls(r,e){let s=`${r.request||"Session started"} (${e})`;return[`${m.yellow}#S${r.id}${m.reset} ${s}`,""]}function V(r,e,s){return e?[`${s}${r}:${m.reset} ${e}`,""]:[]}function Cs(r){return r.assistantMessage?["","---","",`${m.bright}${m.magenta}Previously${m.reset}`,"",`${m.dim}A: ${r.assistantMessage}${m.reset}`,""]:[]}function Ds(r,e){let s=Math.round(r/1e3);return["",`${m.dim}Access ${s}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${m.reset}`]}function Ms(r){return`
${m.bright}${m.cyan}[${r}] recent context, ${gs()}${m.reset}
${m.gray}${"\u2500".repeat(60)}${m.reset}

${m.dim}No previous sessions found for this project yet.${m.reset}
`}function ys(r,e,s,t){let n=[];return t?n.push(...Ss(r)):n.push(...is(r)),t?n.push(...fs()):n.push(...as()),t&&(n.push(...Rs()),n.push(...Os())),se(s)&&(t?n.push(...bs(e,s)):n.push(...ds(e,s))),n}var Se=H(require("path"),1);function oe(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return E.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function fe(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Re(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Us(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function vs(r,e){return Se.default.isAbsolute(r)?Se.default.relative(e,r):r}function xs(r,e,s){let t=oe(r);if(t.length>0)return vs(t[0],e);if(s){let n=oe(s);if(n.length>0)return vs(n[0],e)}return"General"}function ht(r){let e=new Map;for(let t of r){let n=t.type==="observation"?t.data.created_at:t.data.displayTime,o=Us(n);e.has(o)||e.set(o,[]),e.get(o).push(t)}let s=Array.from(e.entries()).sort((t,n)=>{let o=new Date(t[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(s)}function ws(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?oe(r.facts).join(`
`):null}function Nt(r,e,s,t){let n=[];n.push(..._s(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=fe(a.displayTime);n.push(...cs(a,d))}else{let a=i.data,d=Re(a.created_at),u=d!==o?d:"";if(o=d,s.has(a.id)){let p=ws(a,t);n.push(...ms(a,u,p,t))}else n.push(us(a,u,t))}return n}function It(r,e,s,t,n){let o=[];o.push(...hs(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,u=fe(_.displayTime);o.push(...Ls(_,u))}else{let _=d.data,u=xs(_.files_modified,n,_.files_read),c=Re(_.created_at),p=c!==a;a=c;let g=s.has(_.id);if(u!==i&&(o.push(...Ns(u)),i=u),g){let N=ws(_,t);o.push(...As(_,c,p,N,t))}else o.push(Is(_,c,p,t))}return o.push(""),o}function At(r,e,s,t,n,o){return o?It(r,e,s,t,n):Nt(r,e,s,t)}function ks(r,e,s,t,n){let o=[],i=ht(r);for(let[a,d]of i)o.push(...At(a,d,e,s,t,n));return o}function Ps(r,e,s){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||s&&e.created_at_epoch<=s.created_at_epoch)}function Fs(r,e){let s=[];return e?(s.push(...V("Investigated",r.investigated,m.blue)),s.push(...V("Learned",r.learned,m.yellow)),s.push(...V("Completed",r.completed,m.green)),s.push(...V("Next Steps",r.next_steps,m.magenta))):(s.push(...W("Investigated",r.investigated)),s.push(...W("Learned",r.learned)),s.push(...W("Completed",r.completed)),s.push(...W("Next Steps",r.next_steps))),s}function $s(r,e){return e?Cs(r):ps(r)}function Hs(r,e,s){return!se(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:s?Ds(r.totalDiscoveryTokens,r.totalReadTokens):ls(r.totalDiscoveryTokens,r.totalReadTokens)}var Lt=Gs.default.join((0,Xs.homedir)(),".claude","plugins","marketplaces","ormequ","plugin",".install-version");function Ct(){try{return new K}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Bs.unlinkSync)(Lt)}catch(e){e instanceof Error?E.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):E.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return E.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Dt(r,e){return e?Ms(r):Ts(r)}function Mt(r,e,s,t,n,o,i){let a=[],d=ge(e);a.push(...ys(r,d,t,i));let _=s.slice(0,t.sessionCount),u=ts(_,s),c=rs(e,u),p=ns(e,t.fullObservationCount);a.push(...ks(c,p,t,n,i));let g=s[0],N=e[0];Ps(t,g,N)&&a.push(...Fs(g,i));let h=ss(e,t,o,n);return a.push(...$s(h,i)),a.push(...Hs(d,t,i)),a.join(`
`).trimEnd()}var yt=new Set(["bugfix","discovery","decision","refactor"]);function vt(r,e,s){let t=ge(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let _=yt.has(d.type)?d.type:"other";n[_]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:t.totalReadTokens,tokens_saved_vs_naive:t.savings,search_strategy:s?"full":"timeline"}}async function Oe(r,e=!1){let s=qe(),t=r?.cwd??process.cwd(),n=We(t),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(s.totalObservationCount=999999,s.sessionCount=999999);let a=Ct();if(!a)return{text:"",stats:null};try{let d=r?.platformSource?L(r.platformSource):void 0,_=o.length>1?o:[i],u=Ze(a,_,s,d),c=es(a,_,s,d);return u.length===0&&c.length===0?{text:Dt(i,e),stats:null}:{text:Mt(i,u,c,s,t,r?.session_id,e),stats:vt(u,c,!!r?.full)}}finally{a.close()}}async function js(r,e=!1){return(await Oe(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});

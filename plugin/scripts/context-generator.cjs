"use strict";var js=Object.create;var q=Object.defineProperty;var Ws=Object.getOwnPropertyDescriptor;var Vs=Object.getOwnPropertyNames;var qs=Object.getPrototypeOf,Ys=Object.prototype.hasOwnProperty;var Ks=(r,e)=>{for(var s in e)q(r,s,{get:e[s],enumerable:!0})},be=(r,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Vs(e))!Ys.call(r,n)&&n!==s&&q(r,n,{get:()=>e[n],enumerable:!(t=Ws(e,n))||t.enumerable});return r};var H=(r,e,s)=>(s=r!=null?js(qs(r)):{},be(e||!r||!r.__esModule?q(s,"default",{value:r,enumerable:!0}):s,r)),Js=r=>be(q({},"__esModule",{value:!0}),r);var Ut={};Ks(Ut,{generateContext:()=>Bs,generateContextWithStats:()=>Oe});module.exports=Js(Ut);var Hs=H(require("path"),1),Gs=require("os"),Xs=require("fs");var pe=require("bun:sqlite"),J=require("fs");var S=require("path"),ae=require("os"),P=require("fs"),Ne=require("url");var T=require("fs"),he=require("crypto"),y=require("path");var Qs=null;function zs(r){return(Qs??process.stderr.write.bind(process.stderr))(r)}function w(r){zs(r)}var Zs=process.platform==="win32";function et(r){return r.replace(/^\uFEFF/,"")}function k(r){return JSON.parse(et(r))}function st(r){(0,T.existsSync)(r)||(0,T.mkdirSync)(r,{recursive:!0})}function ie(r,e){let s=r;try{if((0,T.lstatSync)(r).isSymbolicLink())try{s=(0,T.realpathSync)(r)}catch(_){let u=_ instanceof Error?_:new Error(String(_));w(`claude-mem: realpathSync failed for ${r}, resolving symlink manually: ${u.message}
`);let c=(0,T.readlinkSync)(r);s=(0,y.resolve)((0,y.dirname)(r),c)}}catch(_){let u=_.code;if(u!=="ENOENT"&&u!=="ENOTDIR")throw _}st((0,y.dirname)(s));let t=(0,y.dirname)(s),n=(0,y.basename)(s),o=(0,y.join)(t,`.${n}.${process.pid}.${(0,he.randomBytes)(6).toString("hex")}.tmp`),i=Buffer.from(JSON.stringify(e,null,2)+`
`,"utf-8"),a;try{a=(0,T.statSync)(s).mode&511}catch{}let d;try{d=a!==void 0?(0,T.openSync)(o,"w",a):(0,T.openSync)(o,"w");let _=0;for(;_<i.length;){let u=(0,T.writeSync)(d,i,_,i.length-_);if(u===0)throw new Error(`writeSync stalled at ${_}/${i.length} bytes`);_+=u}if((0,T.fsyncSync)(d),(0,T.closeSync)(d),d=void 0,(0,T.renameSync)(o,s),!Zs){let u;try{u=(0,T.openSync)(t,"r"),(0,T.fsyncSync)(u)}catch(c){let p=c instanceof Error?c:new Error(String(c));w(`claude-mem: directory fsync failed for ${t}: ${p.message}
`)}finally{if(u!==void 0)try{(0,T.closeSync)(u)}catch{}}}}catch(_){if(d!==void 0)try{(0,T.closeSync)(d)}catch{}try{(0,T.unlinkSync)(o)}catch{}throw _}}var at={};function tt(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,Ne.fileURLToPath)(at.url))}var rt=tt();function nt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,S.join)((0,ae.homedir)(),".claude-mem"),e=(0,S.join)(r,"settings.json");try{if((0,P.existsSync)(e)){let s=k((0,P.readFileSync)(e,"utf-8")),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return t.CLAUDE_MEM_DATA_DIR}}catch{}return r}var I=nt(),de=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,ae.homedir)(),".claude"),Ht=(0,S.join)(de,"plugins","marketplaces","ormequ"),ot=(0,S.join)(I,"logs"),Gt=(0,S.join)(I,"settings.json"),Ie=(0,S.join)(I,"claude-mem.db"),it=(0,S.join)(I,"observer-sessions"),_e=(0,S.basename)(it);function Ae(r){(0,P.mkdirSync)(r,{recursive:!0})}function Le(){return(0,S.join)(rt,"..")}var x={dataDir:()=>I,workerPid:()=>(0,S.join)(I,"worker.pid"),serverPid:()=>(0,S.join)(I,".server-beta.pid"),serverPort:()=>(0,S.join)(I,".server-beta.port"),serverRuntime:()=>(0,S.join)(I,".server-beta.runtime.json"),settings:()=>(0,S.join)(I,"settings.json"),database:()=>(0,S.join)(I,"claude-mem.db"),chroma:()=>(0,S.join)(I,"chroma"),combinedCerts:()=>(0,S.join)(I,"combined_certs.pem"),transcriptsConfig:()=>(0,S.join)(I,"transcript-watch.json"),transcriptsState:()=>(0,S.join)(I,"transcript-watch-state.json"),cloudSyncState:()=>(0,S.join)(I,"cloud-sync-state.json"),corpora:()=>(0,S.join)(I,"corpora"),supervisorRegistry:()=>(0,S.join)(I,"supervisor.json"),envFile:()=>(0,S.join)(I,".env"),logsDir:()=>ot};var v=require("fs"),Ce=require("path");var ue=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(ue||{}),Ee=null,me=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ce.join)(e,`claude-mem-${s}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,v.existsSync)(e)){let s=(0,v.readFileSync)(e,"utf-8"),n=(k(s).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=ue[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`}function Ms(r,e,s,t){let n=[];return t?n.push(...gs(r)):n.push(...os(r)),t?n.push(...Ss()):n.push(...is()),t&&(n.push(...fs()),n.push(...Rs())),se(s)&&(t?n.push(...Os(e,s)):n.push(...as(e,s))),n}var Se=H(require("path"),1);function oe(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return E.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function fe(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Re(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function vs(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function ys(r,e){return Se.default.isAbsolute(r)?Se.default.relative(e,r):r}function Us(r,e,s){let t=oe(r);if(t.length>0)return ys(t[0],e);if(s){let n=oe(s);if(n.length>0)return ys(n[0],e)}return"General"}function ht(r){let e=new Map;for(let t of r){let n=t.type==="observation"?t.data.created_at:t.data.displayTime,o=vs(n);e.has(o)||e.set(o,[]),e.get(o).push(t)}let s=Array.from(e.entries()).sort((t,n)=>{let o=new Date(t[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(s)}function xs(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?oe(r.facts).join(`
`):null}function Nt(r,e,s,t){let n=[];n.push(...ds(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=fe(a.displayTime);n.push(...ms(a,d))}else{let a=i.data,d=Re(a.created_at),u=d!==o?d:"";if(o=d,s.has(a.id)){let p=xs(a,t);n.push(...us(a,u,p,t))}else n.push(Es(a,u,t))}return n}function It(r,e,s,t,n){let o=[];o.push(...bs(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,u=fe(_.displayTime);o.push(...As(_,u))}else{let _=d.data,u=Us(_.files_modified,n,_.files_read),c=Re(_.created_at),p=c!==a;a=c;let g=s.has(_.id);if(u!==i&&(o.push(...hs(u)),i=u),g){let N=xs(_,t);o.push(...Is(_,c,p,N,t))}else o.push(Ns(_,c,p,t))}return o.push(""),o}function At(r,e,s,t,n,o){return o?It(r,e,s,t,n):Nt(r,e,s,t)}function ws(r,e,s,t,n){let o=[],i=ht(r);for(let[a,d]of i)o.push(...At(a,d,e,s,t,n));return o}function ks(r,e,s){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||s&&e.created_at_epoch<=s.created_at_epoch)}function Ps(r,e){let s=[];return e?(s.push(...V("Investigated",r.investigated,m.blue)),s.push(...V("Learned",r.learned,m.yellow)),s.push(...V("Completed",r.completed,m.green)),s.push(...V("Next Steps",r.next_steps,m.magenta))):(s.push(...W("Investigated",r.investigated)),s.push(...W("Learned",r.learned)),s.push(...W("Completed",r.completed)),s.push(...W("Next Steps",r.next_steps))),s}function Fs(r,e){return e?Ls(r):cs(r)}function $s(r,e,s){return!se(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:s?Cs(r.totalDiscoveryTokens,r.totalReadTokens):ps(r.totalDiscoveryTokens,r.totalReadTokens)}var Lt=Hs.default.join((0,Gs.homedir)(),".claude","plugins","marketplaces","ormequ","plugin",".install-version");function Ct(){try{return new K}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Xs.unlinkSync)(Lt)}catch(e){e instanceof Error?E.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):E.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return E.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Dt(r,e){return e?Ds(r):ls(r)}function Mt(r,e,s,t,n,o,i){let a=[],d=ge(e);a.push(...Ms(r,d,t,i));let _=s.slice(0,t.sessionCount),u=ss(_,s),c=ts(e,u),p=rs(e,t.fullObservationCount);a.push(...ws(c,p,t,n,i));let g=s[0],N=e[0];ks(t,g,N)&&a.push(...Ps(g,i));let h=es(e,t,o,n);return a.push(...Fs(h,i)),a.push(...$s(d,t,i)),a.join(`
`).trimEnd()}var yt=new Set(["bugfix","discovery","decision","refactor"]);function vt(r,e,s){let t=ge(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let _=yt.has(d.type)?d.type:"other";n[_]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:t.totalReadTokens,tokens_saved_vs_naive:t.savings,search_strategy:s?"full":"timeline"}}async function Oe(r,e=!1){let s=Ve(),t=r?.cwd??process.cwd(),n=je(t),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(s.totalObservationCount=999999,s.sessionCount=999999);let a=Ct();if(!a)return{text:"",stats:null};try{let d=r?.platformSource?L(r.platformSource):void 0,_=o.length>1?o:[i],u=ze(a,_,s,d),c=Ze(a,_,s,d);return u.length===0&&c.length===0?{text:Dt(i,e),stats:null}:{text:Mt(i,u,c,s,t,r?.session_id,e),stats:vt(u,c,!!r?.full)}}finally{a.close()}}async function Bs(r,e=!1){return(await Oe(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});

...
// Usage:
//   bun scripts/rank-replay.ts --project acme-app \
//     --file "resources/js/Pages/Admin/Dashboard.vue" --killer 24717 \
//     --file "app/Services/Billing/InvoiceImporter.php" --killer 25165 --killer 25175
//
